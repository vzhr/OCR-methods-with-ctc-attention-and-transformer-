...
tf.app.flags.DEFINE_integer('input_size', 128, "input image size")
activation = tf.nn.relu

def resnet_backbone(x, is_training,
              num_classes=1000,
    ...
    with tf.variable_scope('scale3'):
        ...
        print('scale3 stack stride', c['stack_stride'])
    ...
    with tf.variable_scope('scale4'):
        ...
        print('scale4 stack stride', c['stack_stride'])
        x = stack(x, c)

    with tf.variable_scope('scale5'):
        c['num_blocks'] = num_blocks[3]
        c['block_filters_internal'] = FLAGS.out_channels
        print('scale5 stack stride', c['stack_stride'])
        x = stack(x, c)
    return x
