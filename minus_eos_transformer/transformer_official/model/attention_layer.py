...
class Attention(tf.layers.Layer):
    ...
    """
        with tf.name_scope("combine_heads"):
            ...
            #weight mutihead-attention
            
            x = tf.transpose(
                x, [0, 2, 1, 3])  # --> [batch, length, num_heads, depth]
            return tf.reshape(x, [batch_size, length, self.hidden_size])

    def call(self, x, y, bias, cache=None, i=-1):
    ...
    """
        ...
        attention_output = self.combine_heads(attention_output, i)
...
class SelfAttention(Attention):
    ...
    def call(self, x, bias, cache=None, i=-1):
        return super(SelfAttention, self).call(x, x, bias, cache, i)
